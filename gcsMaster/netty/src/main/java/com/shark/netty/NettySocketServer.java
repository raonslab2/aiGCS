...
public class NettySocketServer implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            b.group(bossGroup, workerGroup)
             ...
             .childHandler(new NettySocketServerInitializer(conn,pool,stmt,port));
    ...
    public static void main(String[] args) throws Exception {
		...
		/*
		Runnable task2 = new WebCall(conn,pool,stmt,port);
		Thread thread2 = new Thread(task2);
		thread2.start();
		System.out.println("Websocket Relay Start");
		*/
	}
}