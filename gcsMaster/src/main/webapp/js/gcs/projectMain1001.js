	...
	projectListView(row) {
	    return `
	        <tr id="subRow" class="subTr" style="cursor:pointer;">
	            ...
	            <td>
	                ${row.dlDiv === "0"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_0">(2D)</button>`
	                    : row.dlDiv === "1"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_1">(2D-매핑)</button>`
	                    : row.dlDiv === "2"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_2">(3D-회랑)</button>`
	                    : row.dlDiv === "3"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_3">(2D-파사드)</button>`
	                    : row.dlDiv === "4"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_4">(3D-단면형)</button>`
	                    : row.dlDiv === "5"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_5">(2D/OFF)</button>`
	                    : row.dlDiv === "6"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_6">(6View)</button>`
	                    : row.dlDiv === "7"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_7">(7View)</button>`
	                    : row.dlDiv === "8"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_8">(8View)</button>`
	                    : row.dlDiv === "9"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_9">(9View)</button>`
	                    : row.dlDiv === "10"
	                    ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_10">(10View)</button>`
	                    : ''
	                }
	            </td>
		            ...
		            <div class="content">
		                ...
		                <div class="meta">
		                    ...
		                    ${row.dlDiv === "0"
		                        ...
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_3">(2D-파사드)</button>`
		                        : row.dlDiv === "4"
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_4">(3D-단선형)</button>`
		                        : row.dlDiv === "5"
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_5">(2D/OFF)</button>`
		                        : row.dlDiv === "6"
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_6">(6번-설명)</button>`
		                        : row.dlDiv === "7"
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_7">(7번-설명)</button>`
		                        : row.dlDiv === "8"
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_8">(8번-설명)</button>`
		                        : row.dlDiv === "9"
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_9">(9번-설명)</button>`
		                        : row.dlDiv === "10"
		                        ? `<button type="button" onclick="GcsDashboard.fn_waypoint2D(${row.dlPk}); return false;" class="btn_style03 btn_dlDiv_10">(10번-설명)</button>`
		                        : ''
		                    }
		                </div>
		            </div>
