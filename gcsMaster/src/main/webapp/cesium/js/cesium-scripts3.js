(function () {
    ...
    //위치정보 시작점
    const DEFAULT_LAT = 127.74729458;    
    const DEFAULT_LNG = 37.21009468;
    ...
    var viewer = cesium_create_viewer('cesiumContainer')
    ...
    $(document).on('click', '#waypointCreate', function (e) {
    	...
    	//var jsonObj = JSON.parse(mission);    	
    	console.log("jsonObj: "+jsonObj); 
    	
    	var dlPk = $('#dlPk').val()
     
		$.post("/gcs/dashboard/gA03Main2Waypoint.do", {data:jsonObj,addr:addr,dlPk:dlPk,missionNmae:missionName}).done(function(res) { 
			alert("Registered successfully."); 
			window.location.href = "./gA03Main.do"; 
		}).fail(function() {
			alert("실패");
		});
