...
//비행 금지구역
entities.add({
	position: Cesium.Cartesian3.fromDegrees(128.46534933245377, 36.17249817950348, 100.0),
	cylinder: {
...
entities.add({
	position: Cesium.Cartesian3.fromDegrees(128.46634933245377, 36.17749817950348, 100.0),
	cylinder: {
		hierarchy: new Cesium.PolygonHierarchy(
			Cesium.Cartesian3.fromDegreesArray([
				-118.0,
...
entities.add({
	position: Cesium.Cartesian3.fromDegrees(128.45734933245377, 36.17149817950348),
	ellipse: {
		semiMinorAxis: 200.0,
		semiMajorAxis: 200.0,
...
entities.add({
	position: Cesium.Cartesian3.fromDegrees(128.46634933245377, 36.17749817950348),
	ellipse: {
		semiMinorAxis: 200.0,
		semiMajorAxis: 500.0,
		rotation: Cesium.Math.toRadians(30.0),
...
entities.add({
	position: Cesium.Cartesian3.fromDegrees(128.45634933245377, 36.18749817950348),
	ellipse: {
		semiMinorAxis: 200.0,
		semiMajorAxis: 300.0,
		height: 150.0,
...
async function loadModel() {
	...
	const airplaneUri = await Cesium.IonResource.fromAssetId(748324);
	const airplaneUri2 = await Cesium.IonResource.fromAssetId(1567512);
	...
	const airplaneEntity = viewer.entities.add({
		...
		path: new Cesium.PathGraphics(
			{
				width: 100, 
				material: Cesium.Color.AQUAMARINE.withAlpha(0.0)
			},
		),
	...
	const airplaneEntity2 = viewer.entities.add({
	 ...
	 viewer.entities.add({
	  polylineVolume: {
	    positions:positions,
	    shape: starPositions(9, 15.0, 10.0),
	    outline: true, 
	    outlineWidth: 1,
