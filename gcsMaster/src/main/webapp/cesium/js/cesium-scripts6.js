    ...
    const DEFAULT_LAT = 42.882734153837475  ;
    const DEFAULT_LNG = 74.61370853253275;
    ...
    */
    ...
    //키르기즈스탄
    var initialPosition = new Cesium.Cartesian3.fromDegrees(74.61370853253275, 42.882734153837475, 1200.0);
    //경운대학교
    ...
    removeWaypoint.setInputAction(function(click) {
        ...
        if(pickedObject !== undefined  && pickedObject.type === "waypoint" && $('#btnPath').is(":checked") == true) { 
    ...
    selectWaypoint.setInputAction(function (click) {
        ...
        }else if(pickedObject !== undefined  && pickedObject.type === "waypoint2" && $('#btnPath').is(":checked") == true){
