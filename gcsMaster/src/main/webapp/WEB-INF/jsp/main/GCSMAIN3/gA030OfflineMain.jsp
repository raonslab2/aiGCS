...
<title>DID Blockchain 기반 군집드론 플랫폼</title> 
	  ...
	  <script type="text/javascript" src="<c:url value="/cesium/websocket/layout01_off.js"/>"></script>
    ...
    <link rel=stylesheet href="<c:url value="/js/wi/slider/slider.css"/>"/>
     ...
     <link rel="stylesheet" href="/offline/leaflet/leaflet.css" integrity="sha256-p4NxAoJBhIIN+hmNHrzRCf9tD/miZyoHS5obTRR9BMY=" crossorigin=""/>
    <script src="/offline/leaflet/leaflet.js" integrity="sha256-20nQCchB9co0qIjJZRGuk2/Z9VM+kNiyxNV1lvTlZBo=" crossorigin=""></script>
...
<input id="drone101x" name="drone101x" type="hidden" value=""  >
<input id="drone101y" name="drone101y" type="hidden" value=""  >
<input id="drone101z" name="drone101z" type="hidden" value=""  >
<input id="drone101r" name="drone101r" type="hidden" value=""  >
<input id="drone101p" name="drone101p" type="hidden" value=""  >
<input id="drone101y" name="drone101y" type="hidden" value=""  >
<input id="drone101h" name="drone101h" type="hidden" value=""  >

<input id="drone102x" name="drone102x" type="hidden" value=""  >
<input id="drone102y" name="drone102y" type="hidden" value=""  >
<input id="drone102z" name="drone102z" type="hidden" value=""  >
<input id="drone102r" name="drone102r" type="hidden" value=""  >
<input id="drone102p" name="drone102p" type="hidden" value=""  >
<input id="drone102y" name="drone102y" type="hidden" value=""  >
<input id="drone102h" name="drone102h" type="hidden" value=""  >

<input id="drone103x" name="drone103x" type="hidden" value=""  >
<input id="drone103y" name="drone103y" type="hidden" value=""  >
<input id="drone103z" name="drone103z" type="hidden" value=""  >
<input id="drone103r" name="drone103r" type="hidden" value=""  >
<input id="drone103p" name="drone103p" type="hidden" value=""  >
<input id="drone103y" name="drone103y" type="hidden" value=""  >
<input id="drone103h" name="drone103h" type="hidden" value=""  >

<input id="drone104x" name="drone104x" type="hidden" value=""  >
<input id="drone104y" name="drone104y" type="hidden" value=""  >
<input id="drone104z" name="drone104z" type="hidden" value=""  >
<input id="drone104r" name="drone104r" type="hidden" value=""  >
<input id="drone104p" name="drone104p" type="hidden" value=""  >
<input id="drone104y" name="drone104y" type="hidden" value=""  >
<input id="drone104h" name="drone104h" type="hidden" value=""  >

<input id="drone105x" name="drone105x" type="hidden" value=""  >
<input id="drone105y" name="drone105y" type="hidden" value=""  >
<input id="drone105z" name="drone105z" type="hidden" value=""  >
<input id="drone105r" name="drone105r" type="hidden" value=""  >
<input id="drone105p" name="drone105p" type="hidden" value=""  >
<input id="drone105y" name="drone105y" type="hidden" value=""  >
<input id="drone105h" name="drone105h" type="hidden" value=""  >
 ...
 <div id="waypointControls">
   ...
   <table align="center"  >
    ...
    --> 
     ...
     <!--Toolbar Tools-->
     <td width="800px;text-align:center">   
         <form id="swarm" name="swarm"  method="post" action="">
         <label for="lm_10001"><input type="checkbox" name="chk[]" class='idx' id="lm_10001" value="lm_10001" />
         <p5 for="horns" style="color:yellow;">D-1001</p5>
         </label>
         
         <label for="lm_10002"><input type="checkbox" name="chk[]" class='idx' id="lm_10002" value="lm_10002" />
         <p5 for="horns" style="color:yellow;">D-1002</p5>
         </label>
         <label for="lm_10003"><input type="checkbox" name="chk[]" class='idx' id="lm_10003" value="lm_10003" />
         <p5 for="horns" style="color:yellow;">D-1003</p5>
         </label>
         <label for="lm_10004"><input type="checkbox" name="chk[]" class='idx' id="lm_10004" value="lm_10004" />
         <p5 for="horns" style="color:yellow;">D-1004</p5>
         </label>
         <label for="lm_10005"><input type="checkbox" name="chk[]" class='idx' id="lm_10005" value="lm_10005" />
         <p5 for="horns" style="color:yellow;">D-1005</p5>
         </label>
         </form>
     </td> 
		       ...
		       <table width="100%" heiht="30px" style="color: white; padding:5px;margin-top:5px;" > 
				 ...
				 <thead>
				    <tr>
				     ...
				     <td style="text-align:center;"> <p5><a style="color:white" href="<c:url value='/gcs/dashboard/gA030OfflineMain.do'/>">GCS RELOAD</a></p5></td> 
...
<script type="text/javascript" src="<c:url value="/cesium/websocket/gA030OfflineMain.js"/>"></script>
