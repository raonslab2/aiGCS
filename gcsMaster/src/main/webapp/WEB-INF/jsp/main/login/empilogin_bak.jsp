...
function actionLogin() {
    ...
    if (document.loginForm.id.value =="") {
        ...
        document.loginForm.action="<c:url value='/empo/login/actionLogin.do'/>";
...
<div id="wrap">
    <!-- header 시작 -->
    <div id="header_mainsize">head</div>
                    ...
                    <div class="user_login">
                        ...
                        <div class="user_login_btstyle">
                            <ul class="bt_ulstyle1">
                                <li>
                                 <input type="checkbox" name="checkId" onclick="javascript:saveid(this.form);" id="checkId" /><label for="checkId">로그인 상태 유지</label>
                                </li>
                            </ul>
                            <ul class="bt_ulstyle2">
                                <li><a href="" >비밀번호 기억이 안나요</a></li>
                            </ul>
                        </div>
