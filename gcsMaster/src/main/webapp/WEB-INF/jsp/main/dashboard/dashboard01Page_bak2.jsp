				...
				<div class="dashboard_guide"> 
					<div class="tasks_guide">
						...
						<div class="btn_guide ar">  
							<a href="<c:url value='#'/>" class="btn_style02 btn_white sb_style ">년도별 통계</a>
						</div>
						<div class="bbs_list2" style="margin-top:17px;">
		                	<table id="bbs_list1"> 
								...
								<tr> 
								  ...
								  <th scope="col">온라인 서면평가</th>
								  <th scope="col">서면평가</th>
								  <th scope="col">대면평가</th> 
								  <th scope="col">심층평가</th>
...
;(function() { 
	...
	var initList = function() {
		...
		var tmArry = searchTodayVal.split('-');
		var tmYear = parseInt(tmArry[0]);
		var tmStr;
		//$('#resultList').remove();
		for(var ii=0;ii<8;ii++){
			...
			$.post('/empo/dashboard/eMAU00A0101Sum.do', {searchYy:tmStr}).done(function(res) {
 
				$('#resultList').append(res.list);
				/*
				res.list.forEach(function(row, index) {   
					$('#resultList').append(managerSumView(row));
				}); 
				*/
