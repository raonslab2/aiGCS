...
<div class="popup_guide popup_w700">	
	...
	<div class="popup_top_btn">
		...
		<button type="submit" class="btn_style01 btn_red" id="btnPopConfirm">수정</button>
	</div>
	...
	<div class="popup_content">
		<div class="sbox_h600 scroll">
			<div class="bbs_write01">
				<ul>
					<li><span>제목</span>
					<input type="text" class="input_w100" placeholder="세부사업명을 입력하세요." value="분과구성 협의 회의">
					<label><input type="checkbox" name=""> Check List 추가</label>
					</li>

					<li><span>시작</span>
					<input type="text" class="inputCalendar input_w40" name="" id="" value="07월 13일 (화)">
					<input type="text" class="input_w30 ac timepicker" value="오전 10:00">
					&nbsp;
					<label>시간대 <input type="checkbox" name=""> 종일</label>
					
					<li><span>종료</span>
					<input type="text" class="inputCalendar input_w40" name="" id="" value="07월 13일 (화)">
					<input type="text" class="input_w30 ac timepicker" value="오전 11:00">

					<li><span>설명</span>
					<input type="text" class="input_w100" placeholder="설명을 입력하세요." value="수출확대형 2차 사업 어쩌고 저쩌고">
					</li>
					
					<li><span class="notice btnPopNoticeAddView">알림추가 +</span>
					<input type="text" class="input_w100 btnPopNoticeAddView" id="noticeList" placeholder="알림추가 +" value="10분 전, 1시간 전">
					...
					<input type="text" class="input_w100 btnPopScheduleAddView" id="scheduleList" placeholder="일정 공유 +" value="정보화지원실 홍누구 책임, 대외협력실 이협력 주임">
					...
					<li><span class="btnFileAdd"  style="cursor:pointer;">첨부파일 추가 +</span>
						<a href="#"><span class="file">파일명1.hwp</span></a>
						<a href="#"><span class="file">파일명1.hwp</span></a>
						<a href="#"><span class="file">파일명1.hwp</span></a>
						<a href="#"><span class="file">파일명1.hwp</span></a>
						
						<div class="btn_guide al mt10">
