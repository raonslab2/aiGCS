...
<head>
  ...
  <link href="/css/gcs/TodayWork101.css" rel="stylesheet">
...
<div id="image-container">
    <img src="/images/DJI_0001.JPG" alt="Image">
</div>
<input type="text" id="label-name-input" placeholder="라벨링 이름 등록">
<button id="save-button">저장</button>
   ...
   <footer>
    ...
    <script type="text/javascript" src="/js/gcs/TodayWork101.js"></script>
