		...
		<div class="container">
			<div class="location-content">
				<div class="location-area">
					<span class="location">타깃 세일즈 / <strong>리스트</strong></span>
				</div>
					...
					<div class="visit-box">
										...
										<div class="com-radio-select">
											...
											<ul class="check-list">
												...
												<li>
													...
													<label for="location-radio-2">20P</label>
												</li>
											</ul>
										</div>
										<div class="txt-info">
						...
						<div class="advice-area">
							<div class="top-tab-item">
								<div class="tab-btn">
									<button type="button" class="on" onclick="location.href='target_company_B_1.html'">비대면 상담</button>
									<button type="button" onclick="location.href='target_company_B_1_a.html'">대면 상담</button>
								</div>
								<div class="action-btn">
									<div class="com-radio-select">
