...
<title>INNO GROUP</title>  
        ...
        <c:import url="/EmpPageLink.do?link=main/include/srcInno" />  
	<meta charset="utf-8">	
...
<body>
	...
	<div id="wrap">
		...
		<div class="container">
		    <!-- menu top1 -->
          <c:import url="/EmpPageLink.do?link=main/include/innomenutop" />  
			...
			<div class="view-content">
				...
				<div class="map-info-area">
					<div class="info-list-box table-type ver1">
						  ...
						  <input type="hidden" id="page" name="page" value="" /> 
							<div class="top-search-box">
										...
										<div class="com-radio-select w-100">
											...
											<ul class="check-list">
												...
												<li>
													...
													<label for="sort-radio-8-2">항목생성</label>
												</li>
												<li>
													<input type="radio" name="sort-radio-8" id="sort-radio-8-3">
													<label for="sort-radio-8-3">탭생성</label>
												</li>
											</ul>
										</div>
									</div>
								...
								<div class="sort-wrap">
									...
									<div class="com-paging cp pagination">  
									...
									<table class="check-table">
										...
										<thead>
											<tr>
												...
												<th>소속<br>부서/직위</th>
												<th><span class="sort on">핸드폰(교환번호)<br>전화</span></th>
						...
						<div class="advice-area full">
							<div class="top-tab-item">
								<div class="tab-btn">
									...
									<button type="button" onclick="location.href='target_company_A2.html'">대면 상담</button>
								</div>
...
;(function() { 
	...
	var projectListView = function(row) { 
		...
		var data = "<tr class=\"on\">\r\n"
			...
			+ "	<td>123456</td>\r\n"
			+ "	<td>\r\n"
			+ "		<span class=\"name\">"+row.h01Name+"</span>/37\r\n"
			+ "	</td>\r\n"
			+ "	<td><span class=\"short-txt\">가파이러츠오브가파이러츠오브가파이러츠오브</span></td>\r\n"
			+ "	<td>010-2066-0000</td>\r\n"
			+ "	<td>오후 05시 01분</td>\r\n"
			+ "	<td>bbb_bbb@hanmail.net</td>\r\n"
			+ "	<td><span class=\"facebook\">weareoneexo</span></td>\r\n"
			+ "	<td>서울 강남구 도산대로 447<br></td>\r\n"
