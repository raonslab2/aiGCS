...
%>
			...
			<ul class="menu-list">
				...
				<li>
					<a class="on" href="<c:url value='/inno/EMC00H01/emc00h01.do'/>" class="menu-type"><span>타깃 세일즈</span></a>
					<ul class="sub-menu-list">
						<li>
				...
				<li>
					<a href="<c:url value='/inno/EMD00H01/emd00h01.do'/>" class="menu-type"><span>프로모션</span></a>
					<ul class="sub-menu-list">
						<li>
