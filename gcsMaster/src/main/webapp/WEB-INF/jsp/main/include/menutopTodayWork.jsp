...
<div class="header">
    <div class="menu-container">  
        <div class="menu-item" data-tab="0">
            <a href="/gcs/TD0001/TodayWork900.do" data-active="0"> 
                My Work
            </a>
        </div> 
        <div class="menu-item" data-tab="1">
            <a href="/gcs/TD0001/TodayWork901.do" data-active="1"> 
                Work List
            </a>
        </div> 
        <div class="menu-item" data-tab="2">
            <a href="/gcs/TD0001/TodayWork902.do" data-active="2"> 
                Work Status
            </a>
        </div> 
        <div class="menu-item" data-tab="3">
            <a href="/gcs/TD0001/TodayWork903.do" data-active="3"> 
                Scheduler
            </a>
        </div> 
        <div class="menu-item" data-tab="5">
            <a href="/gcs/TD0001/TodayWork905.do" target="_blank" data-active="5"> 
                Mobile Chat
            </a>
        </div>
