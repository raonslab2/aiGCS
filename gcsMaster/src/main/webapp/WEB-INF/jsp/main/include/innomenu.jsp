...
%>
			...
			<ul class="menu-list">
				<li>
					<a  href="<c:url value='/inno/EMA00H01/h01001.do'/>" class="menu-type on"><span>주소록관리</span></a>
				...
				<li>
					<a <% if (url.indexOf("emb00h01") > -1) { %> class="on" <% } %> href="<c:url value='/inno/EMB00H01/emb00h01.do'/>" ><span>스케줄</span></a>
					
				</li>
				<li>
					<a <% if (url.indexOf("emc00h01") > -1) { %> class="on" <% } %> href="<c:url value='/inno/EMC00H01/emc00h01.do'/>" class="menu-type"><span>타깃 세일즈</span></a>
					<ul class="sub-menu-list">
						<li>
				...
				<li>
					<a <% if (url.indexOf("emd00h01") > -1) { %> class="on" <% } %> href="<c:url value='/inno/EMD00H01/emd00h01.do'/>" class="menu-type"><span>프로모션</span></a>
					<ul class="sub-menu-list">
						<li>
