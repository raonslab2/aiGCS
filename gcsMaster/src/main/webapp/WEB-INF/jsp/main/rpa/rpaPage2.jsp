...
<div class="ui-layout-center">
         ...
         <div style="width:500px;">
          <table class="table_default" style="width:100%;padding:5px;" >
            ...
            <tr>
              ...
              <td>
              <div class="search">
			     <input type="text" id="searchRpaPjList" name="searchRpaPjList" placeholder="사업명을 입력해주세요." size="34">
			     <button id="searchbutton" class="searchbutton" type="submit" onlick="choice()" value="Get Value">선택</button>
			     <input type="text" id="resultPjCode" name="resultRpaPjList" size="6">
			     <input type="text" id="resultPjName" name="resultRpaPjList" size="25">
					</div>
			  <div id = "searchbusiness" name="searchbusiness">
    ...
    <div id="searchBusiness" style="clear:both;margin-top:10px;" > <br />
		
       	차수 * <select name='degree' class= 'degree' id='degree'>
			    <!-- <option value="1">1차</option>
			    <option value="2">2차</option>
			    <option value="3">3차</option>
			    <option value="4">4차</option> -->
			</select> <br /><br />
       	사업부서 * <input type="text" id="businessDepart" name="businessDepart" required minlength="4" maxlength="8" size="25">
       	담당자 정보 * <input type="text" id="ContactInfo" name="ContactInfo" required minlength="4" maxlength="8" size="10"><br />

		 <a href="#" class="button white medium" onclick="searchList();">자료요청</a>
</div>	  
    </div>
    </div>  
        <!-- //container 끝 -->  
 ...
 <script type="text/javascript"> 	
	...
	$(document).on('click', '#searchbutton',function(){
		...
		,	data : 
			...
			console.log(res.list)
			$(document).ready(function(){
				$('#resultPjCode').val(res.list.pjCode);	
				$('#resultPjName').val(res.list.pjTitle);
			
				var a = res.list.pjTitle;
				$('#resultPjName').val(a);
				...
				if(a.includes(c)){
					...
					$('#degree').append('<option value="' + c + '">' + c + '</option>');
				} 
