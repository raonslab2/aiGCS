...
public class EMD00H01Controller {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(EMD00H01Controller.class);
	 ...
	 */ 
	@RequestMapping("/inno/EMD00H01/emd00h01.do")
	public String emd00h01(@ModelAttribute("eMA00H01VO") EMA00H01VO eMA00H01VO, HttpServletRequest request,
		...
		return "main/INNO/EMD00H01/emd00h01"; 
	}
	 ...
	 * @exception Exception Exception
	 */ 
	@RequestMapping("/inno/EMD00H01/emd00h02.do")
	public String emd00h02(@ModelAttribute("eMA00H01VO") EMA00H01VO eMA00H01VO, HttpServletRequest request,
			ModelMap model) throws Exception {
		...
		return "main/INNO/EMD00H01/emd00h02"; 
	}
